...
// note: 模拟后端响应数据 response.data 的统一格式
let Result = {
  code: 200,
  msg: '操作成功',
  data: null
...
// note: 响应 /captcha 请求，响应验证码图片
Mock.mock('/captcha', 'post', () => {
  // note: 封装数据到 Result 对象中
  Result.data = {
    token: Random.string(32),                          // 随机字符
    captchaImg: Random.dataImage('100x40', 'p7n5w')    // 指定的大小和字符的图片的 base64 编码
  }
			...
			children: [
				{
					...
					path: '/sys/users',
					component: 'sys/User',    // note: 指定路由对应的 component ，用作动态路由绑定
					children: []
				},
				{
					name: 'SysRole',
